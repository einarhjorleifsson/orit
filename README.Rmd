...
The {orit}-package in intended to be helpful when parsing [NMEA-messages](https://en.wikipedia.org/wiki/National_Marine_Electronics_Association).  The aim is that all variables are returned as correct types (integer, numeric, character, date, time, datetime, etc.).
